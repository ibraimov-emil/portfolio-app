...
export interface ApiChatMessageChatMessage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Messages sent in chat rooms';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isAuthenticated: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    isSystemMessage: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPracticePractice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    componentLink: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    Preview: Schema.Attribute.Media<'images' | 'videos', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['start', 'medium', 'advanced']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVacancyVacancy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    experienceLevel: Schema.Attribute.Enumeration<
      ['no-experience', 'junior', 'middle', 'senior', 'lead']
    >;
    hot: Schema.Attribute.Boolean;
    isActive: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
