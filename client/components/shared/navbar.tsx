...
const Navbar = () => {
    return (
        <div
            ...
            <div
                className="fixed bottom-0 inset-x-0 h-16 w-full bg-background to-transparent backdrop-blur-lg [-webkit-mask-image:linear-gradient(to_top,black,transparent)] dark:bg-background"></div>
            <TooltipProvider delayDuration={0}>
                <Dock
                    ...
                    {NAVBAR.main.map((item) => (
                        <DockIcon key={item.href} className={'mx-3'}>
                            <Link
                                href={item.href}
                                className={cn(
